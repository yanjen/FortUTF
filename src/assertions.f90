MODULE FUTF_ASSERTIONS
    ...
    PUBLIC :: ASSERT_EQUAL, ASSERT_ALMOST_EQUAL, ASSERT_NOT_EQUAL
    PUBLIC :: ASSERT_LESS_THAN, ASSERT_LESS_THAN_EQUAL
    PUBLIC :: ASSERT_GREATER_THAN, ASSERT_GREATER_THAN_EQUAL
    PUBLIC :: ASSERT_IS_INT, ASSERT_IS_REAL, ASSERT_IS_CHARACTER, ASSERT_IS_COMPLEX
    PUBLIC :: ASSERT_ARRAY_CONTAINS

    PUBLIC :: INT_KIND_1BYTE, INT_KIND_2BYTE, INT_KIND_4BYTE, INT_KIND_8BYTE
    PUBLIC :: REAL_KIND_4BYTE, REAL_KIND_8BYTE, INFO

    INTEGER, PARAMETER :: INT_KIND_1BYTE = SELECTED_INT_KIND(2)
    INTEGER, PARAMETER :: INT_KIND_2BYTE = SELECTED_INT_KIND(4)
    INTEGER, PARAMETER :: INT_KIND_4BYTE = SELECTED_INT_KIND(9)
    INTEGER, PARAMETER :: INT_KIND_8BYTE = SELECTED_INT_KIND(18)

    INTEGER, PARAMETER :: REAL_KIND_4BYTE = SELECTED_REAL_KIND(6, 37)
    ...
    INTERFACE ASSERT_IS_INT
        MODULE PROCEDURE ASSERT_IS_INT_INT_1BYTE
        MODULE PROCEDURE ASSERT_IS_INT_INT_2BYTE
        MODULE PROCEDURE ASSERT_IS_INT_INT_4BYTE
        MODULE PROCEDURE ASSERT_IS_INT_INT_8BYTE
        MODULE PROCEDURE ASSERT_IS_INT_REAL_8BYTE
        MODULE PROCEDURE ASSERT_IS_INT_REAL_4BYTE
        MODULE PROCEDURE ASSERT_IS_INT_COMPLEX
        MODULE PROCEDURE ASSERT_IS_INT_CHAR
        MODULE PROCEDURE ASSERT_IS_INT_BOOL
    END INTERFACE ASSERT_IS_INT
    ...
    INTERFACE ASSERT_IS_CHARACTER
        MODULE PROCEDURE ASSERT_IS_CHARACTER_INT_1BYTE
        MODULE PROCEDURE ASSERT_IS_CHARACTER_INT_2BYTE
        MODULE PROCEDURE ASSERT_IS_CHARACTER_INT_4BYTE
        MODULE PROCEDURE ASSERT_IS_CHARACTER_INT_8BYTE
        MODULE PROCEDURE ASSERT_IS_CHARACTER_REAL_8BYTE
        MODULE PROCEDURE ASSERT_IS_CHARACTER_REAL_4BYTE
        MODULE PROCEDURE ASSERT_IS_CHARACTER_COMPLEX
        MODULE PROCEDURE ASSERT_IS_CHARACTER_CHAR
        MODULE PROCEDURE ASSERT_IS_CHARACTER_BOOL
    END INTERFACE ASSERT_IS_CHARACTER

    INTERFACE ASSERT_IS_COMPLEX
        MODULE PROCEDURE ASSERT_IS_COMPLEX_INT_1BYTE
        MODULE PROCEDURE ASSERT_IS_COMPLEX_INT_2BYTE
        MODULE PROCEDURE ASSERT_IS_COMPLEX_INT_4BYTE
        MODULE PROCEDURE ASSERT_IS_COMPLEX_INT_8BYTE
        MODULE PROCEDURE ASSERT_IS_COMPLEX_REAL_8BYTE
        MODULE PROCEDURE ASSERT_IS_COMPLEX_REAL_4BYTE
        MODULE PROCEDURE ASSERT_IS_COMPLEX_COMPLEX
    ...
    SUBROUTINE ASSERT_EQUAL_INT_1BYTE(INT_1, INT_2)
        INTEGER(INT_KIND_1BYTE), INTENT(IN) :: INT_1, INT_2
        IF(INT_1 == INT_2) THEN
    ...
    SUBROUTINE ASSERT_EQUAL_INT_2BYTE(INT_1, INT_2)
        INTEGER(INT_KIND_2BYTE), INTENT(IN) :: INT_1, INT_2
    ...
    SUBROUTINE ASSERT_EQUAL_INT_4BYTE(INT_1, INT_2)
        INTEGER(INT_KIND_4BYTE), INTENT(IN) :: INT_1, INT_2
    ...
    SUBROUTINE ASSERT_EQUAL_INT_8BYTE(INT_1, INT_2)
        INTEGER(INT_KIND_8BYTE), INTENT(IN) :: INT_1, INT_2
    ...
    SUBROUTINE ASSERT_EQUAL_INT_1BYTE_ARR(INT_1, INT_2)
        INTEGER(INT_KIND_1BYTE), DIMENSION(:), INTENT(IN) :: INT_1, INT_2
        INTEGER :: I
        LOGICAL :: COMPARE
    ...
    SUBROUTINE ASSERT_EQUAL_INT_2BYTE_ARR(INT_1, INT_2)
        INTEGER(INT_KIND_2BYTE), DIMENSION(:), INTENT(IN) :: INT_1, INT_2
    ...
    SUBROUTINE ASSERT_EQUAL_INT_4BYTE_ARR(INT_1, INT_2)
        INTEGER(INT_KIND_4BYTE), DIMENSION(:), INTENT(IN) :: INT_1, INT_2
    ...
    SUBROUTINE ASSERT_EQUAL_INT_8BYTE_ARR(INT_1, INT_2)
        INTEGER(INT_KIND_8BYTE), DIMENSION(:), INTENT(IN) :: INT_1, INT_2
    ...
    SUBROUTINE ASSERT_EQUAL_REAL_8BYTE(REAL_1, REAL_2)
        REAL(REAL_KIND_8BYTE), INTENT(IN) :: REAL_1, REAL_2
    ...
    SUBROUTINE ASSERT_EQUAL_REAL_4BYTE(REAL_1, REAL_2)
        REAL(REAL_KIND_4BYTE), INTENT(IN) :: REAL_1, REAL_2
    ...
    SUBROUTINE ASSERT_EQUAL_REAL_4BYTE_ARR(REAL_1, REAL_2)
        REAL(REAL_KIND_4BYTE), DIMENSION(:), INTENT(IN) :: REAL_1, REAL_2
    ...
    SUBROUTINE ASSERT_EQUAL_REAL_8BYTE_ARR(REAL_1, REAL_2)
        REAL(REAL_KIND_8BYTE), DIMENSION(:), INTENT(IN) :: REAL_1, REAL_2
    ...
    SUBROUTINE ASSERT_EQUAL_LOGICAL(BOOL_1, BOOL_2)
        ...
        IF(BOOL_1 .EQV. BOOL_2) THEN
            CALL REGISTER_PASSED
            WRITE(INFO, '(A, L1, A, L1)') "ASSERT_EQUAL: ", BOOL_1, " == ", BOOL_2
        ELSE
            CALL REGISTER_FAILED
            WRITE(INFO, '(A, L1, A, L1)') "ASSERT_EQUAL: ", BOOL_1, " != ", BOOL_2
        END IF
    ...
    SUBROUTINE ASSERT_ALMOST_EQUAL_INT_1BYTE(INT_1, INT_2, REL_TOL)
        INTEGER(INT_KIND_1BYTE), INTENT(IN) :: INT_1, INT_2
        REAL(REAL_KIND_8BYTE), OPTIONAL :: REL_TOL

        REAL(REAL_KIND_8BYTE) :: TOLERANCE
        LOGICAL PASSES
    ...
    SUBROUTINE ASSERT_ALMOST_EQUAL_REAL_4BYTE(REAL_1, REAL_2, REL_TOL)
        REAL(REAL_KIND_4BYTE), INTENT(IN) :: REAL_1, REAL_2
        REAL(REAL_KIND_4BYTE), OPTIONAL :: REL_TOL

        REAL(REAL_KIND_4BYTE) :: TOLERANCE
        LOGICAL PASSES
    ...
    SUBROUTINE ASSERT_NOT_EQUAL_LOGICAL(BOOL_1, BOOL_2)
        ...
        IF(BOOL_1 .NEQV. BOOL_2) THEN
            CALL REGISTER_PASSED
            WRITE(INFO, '(A, L1, A, L1)') "ASSERT_NOT_EQUAL: ", BOOL_1, " != ", BOOL_2
        ELSE
            CALL REGISTER_FAILED
            WRITE(INFO, '(A, L1, A, L1)') "ASSERT_NOT_EQUAL: ", BOOL_1, " == ", BOOL_2
        END IF
    ...
    SUBROUTINE ASSERT_IS_REAL_REAL_4BYTE(REAL_VAR)
        REAL(REAL_KIND_4BYTE), INTENT(IN) :: REAL_VAR
        CALL REGISTER_PASSED
    ...
    SUBROUTINE ASSERT_IS_REAL_REAL_8BYTE(REAL_VAR)
        REAL(REAL_KIND_8BYTE), INTENT(IN) :: REAL_VAR
        CALL REGISTER_PASSED
        WRITE(INFO, '(A, F0.5, A)') "ASSERT_IS_REAL: ", REAL_VAR, " (REAL)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    ...
    SUBROUTINE ASSERT_IS_REAL_INT_1BYTE(INT_VAR)
        INTEGER(INT_KIND_1BYTE), INTENT(IN) :: INT_VAR
        CALL REGISTER_FAILED
    ...
    SUBROUTINE ASSERT_IS_REAL_INT_2BYTE(INT_VAR)
        INTEGER(INT_KIND_2BYTE), INTENT(IN) :: INT_VAR
        CALL REGISTER_FAILED
        WRITE(INFO, '(A, I0, A)') "ASSERT_IS_REAL: ", INT_VAR, " (INT)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    ...
    SUBROUTINE ASSERT_IS_REAL_INT_4BYTE(INT_VAR)
        INTEGER(INT_KIND_4BYTE), INTENT(IN) :: INT_VAR
        CALL REGISTER_FAILED
        WRITE(INFO, '(A, I0, A)') "ASSERT_IS_REAL: ", INT_VAR, " (INT)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    ...
    SUBROUTINE ASSERT_IS_REAL_INT_8BYTE(INT_VAR)
        INTEGER(INT_KIND_8BYTE), INTENT(IN) :: INT_VAR
        CALL REGISTER_FAILED
        WRITE(INFO, '(A, I0, A)') "ASSERT_IS_REAL: ", INT_VAR, " (INT)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    ...
    SUBROUTINE ASSERT_IS_REAL_BOOL(BOOL_VAR)
        ...
        CALL REGISTER_FAILED
        WRITE(INFO, '(A, L1, A)') "ASSERT_IS_REAL: ", BOOL_VAR, " (LOGICAL)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    ...
    SUBROUTINE ASSERT_IS_INT_REAL_4BYTE(REAL_VAR)
        REAL(REAL_KIND_4BYTE), INTENT(IN) :: REAL_VAR
        CALL REGISTER_FAILED
        WRITE(INFO, '(A, F0.5, A)') "ASSERT_IS_INT: ", REAL_VAR, " (REAL)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    END SUBROUTINE ASSERT_IS_INT_REAL_4BYTE

    SUBROUTINE ASSERT_IS_INT_REAL_8BYTE(REAL_VAR)
        REAL(REAL_KIND_8BYTE), INTENT(IN) :: REAL_VAR
        CALL REGISTER_FAILED
        WRITE(INFO, '(A, F0.5, A)') "ASSERT_IS_INT: ", REAL_VAR, " (REAL)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    END SUBROUTINE ASSERT_IS_INT_REAL_8BYTE

    SUBROUTINE ASSERT_IS_INT_INT_1BYTE(INT_VAR)
        INTEGER(INT_KIND_1BYTE), INTENT(IN) :: INT_VAR
        CALL REGISTER_PASSED
        WRITE(INFO, '(A, I0, A)') "ASSERT_IS_INT: ", INT_VAR, " (INT)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    END SUBROUTINE ASSERT_IS_INT_INT_1BYTE

    SUBROUTINE ASSERT_IS_INT_INT_2BYTE(INT_VAR)
        INTEGER(INT_KIND_2BYTE), INTENT(IN) :: INT_VAR
        CALL REGISTER_PASSED
        WRITE(INFO, '(A, I0, A)') "ASSERT_IS_INT: ", INT_VAR, " (INT)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    END SUBROUTINE ASSERT_IS_INT_INT_2BYTE

    SUBROUTINE ASSERT_IS_INT_INT_4BYTE(INT_VAR)
        INTEGER(INT_KIND_4BYTE), INTENT(IN) :: INT_VAR
        CALL REGISTER_PASSED
        WRITE(INFO, '(A, I0, A)') "ASSERT_IS_INT: ", INT_VAR, " (INT)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    END SUBROUTINE ASSERT_IS_INT_INT_4BYTE

    SUBROUTINE ASSERT_IS_INT_INT_8BYTE(INT_VAR)
        INTEGER(INT_KIND_8BYTE), INTENT(IN) :: INT_VAR
        CALL REGISTER_PASSED
        WRITE(INFO, '(A, I0, A)') "ASSERT_IS_INT: ", INT_VAR, " (INT)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    END SUBROUTINE ASSERT_IS_INT_INT_8BYTE

    SUBROUTINE ASSERT_IS_INT_CHAR(CHAR_VAR)
        CHARACTER(*), INTENT(IN) :: CHAR_VAR
        CALL REGISTER_FAILED
        WRITE(INFO, '(A, A, A)') "ASSERT_IS_INT: ", CHAR_VAR, " (CHAR)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    END SUBROUTINE ASSERT_IS_INT_CHAR

    SUBROUTINE ASSERT_IS_INT_BOOL(BOOL_VAR)
        LOGICAL, INTENT(IN) :: BOOL_VAR
        CALL REGISTER_FAILED
        WRITE(INFO, '(A, L1, A)') "ASSERT_IS_INT: ", BOOL_VAR, " (LOGICAL)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    END SUBROUTINE ASSERT_IS_INT_BOOL

    SUBROUTINE ASSERT_IS_INT_COMPLEX(COMP_VAR)
        COMPLEX, INTENT(IN) :: COMP_VAR
        CALL REGISTER_FAILED
        WRITE(INFO, '(A, F0.5, A, F0.5, A, A)') "ASSERT_NOT_EQUAL: ", REAL(COMP_VAR), " &
               & + ", AIMAG(COMP_VAR), "I", " (COMPLEX)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    END SUBROUTINE ASSERT_IS_INT_COMPLEX

    SUBROUTINE ASSERT_IS_CHARACTER_REAL_4BYTE(REAL_VAR)
        REAL(REAL_KIND_4BYTE), INTENT(IN) :: REAL_VAR
        CALL REGISTER_FAILED
        WRITE(INFO, '(A, F0.5, A)') "ASSERT_IS_CHARACTER: ", REAL_VAR, " (REAL)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    END SUBROUTINE ASSERT_IS_CHARACTER_REAL_4BYTE

    SUBROUTINE ASSERT_IS_CHARACTER_REAL_8BYTE(REAL_VAR)
        REAL(REAL_KIND_8BYTE), INTENT(IN) :: REAL_VAR
        CALL REGISTER_FAILED
        WRITE(INFO, '(A, F0.5, A)') "ASSERT_IS_CHARACTER: ", REAL_VAR, " (REAL)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    END SUBROUTINE ASSERT_IS_CHARACTER_REAL_8BYTE

    SUBROUTINE ASSERT_IS_CHARACTER_INT_1BYTE(INT_VAR)
        INTEGER(INT_KIND_1BYTE), INTENT(IN) :: INT_VAR
        CALL REGISTER_FAILED
        WRITE(INFO, '(A, I0, A)') "ASSERT_IS_CHARACTER: ", INT_VAR, " (INT)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    END SUBROUTINE ASSERT_IS_CHARACTER_INT_1BYTE

    SUBROUTINE ASSERT_IS_CHARACTER_INT_2BYTE(INT_VAR)
        INTEGER(INT_KIND_2BYTE), INTENT(IN) :: INT_VAR
        CALL REGISTER_FAILED
        WRITE(INFO, '(A, I0, A)') "ASSERT_IS_CHARACTER: ", INT_VAR, " (INT)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    END SUBROUTINE ASSERT_IS_CHARACTER_INT_2BYTE

    SUBROUTINE ASSERT_IS_CHARACTER_INT_4BYTE(INT_VAR)
        INTEGER(INT_KIND_4BYTE), INTENT(IN) :: INT_VAR
        CALL REGISTER_FAILED
        WRITE(INFO, '(A, I0, A)') "ASSERT_IS_CHARACTER: ", INT_VAR, " (INT)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    END SUBROUTINE ASSERT_IS_CHARACTER_INT_4BYTE

    SUBROUTINE ASSERT_IS_CHARACTER_INT_8BYTE(INT_VAR)
        INTEGER(INT_KIND_8BYTE), INTENT(IN) :: INT_VAR
        CALL REGISTER_FAILED
        WRITE(INFO, '(A, I0, A)') "ASSERT_IS_CHARACTER: ", INT_VAR, " (INT)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    END SUBROUTINE ASSERT_IS_CHARACTER_INT_8BYTE

    SUBROUTINE ASSERT_IS_CHARACTER_CHAR(CHAR_VAR)
        CHARACTER(*), INTENT(IN) :: CHAR_VAR
        CALL REGISTER_PASSED
        WRITE(INFO, '(A, A, A)') "ASSERT_IS_CHARACTER: ", CHAR_VAR, " (CHAR)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    END SUBROUTINE ASSERT_IS_CHARACTER_CHAR

    SUBROUTINE ASSERT_IS_CHARACTER_BOOL(BOOL_VAR)
        LOGICAL, INTENT(IN) :: BOOL_VAR
        CALL REGISTER_FAILED
        WRITE(INFO, '(A, L1, A)') "ASSERT_IS_CHARACTER: ", BOOL_VAR, " (LOGICAL)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    END SUBROUTINE ASSERT_IS_CHARACTER_BOOL

    SUBROUTINE ASSERT_IS_CHARACTER_COMPLEX(COMP_VAR)
        COMPLEX, INTENT(IN) :: COMP_VAR
        CALL REGISTER_FAILED
        WRITE(INFO, '(A, F0.5, A, F0.5, A, A)') "ASSERT_NOT_EQUAL: ", REAL(COMP_VAR), " &
               & + ", AIMAG(COMP_VAR), "I", " (COMPLEX)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    END SUBROUTINE ASSERT_IS_CHARACTER_COMPLEX

    SUBROUTINE ASSERT_IS_COMPLEX_REAL_4BYTE(REAL_VAR)
        REAL(REAL_KIND_4BYTE), INTENT(IN) :: REAL_VAR
        CALL REGISTER_FAILED
        WRITE(INFO, '(A, F0.5, A)') "ASSERT_IS_COMPLEX: ", REAL_VAR, " (REAL)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    END SUBROUTINE ASSERT_IS_COMPLEX_REAL_4BYTE

    SUBROUTINE ASSERT_IS_COMPLEX_REAL_8BYTE(REAL_VAR)
        REAL(REAL_KIND_8BYTE), INTENT(IN) :: REAL_VAR
        CALL REGISTER_FAILED
        WRITE(INFO, '(A, F0.5, A)') "ASSERT_IS_COMPLEX: ", REAL_VAR, " (REAL)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    END SUBROUTINE ASSERT_IS_COMPLEX_REAL_8BYTE

    SUBROUTINE ASSERT_IS_COMPLEX_INT_1BYTE(INT_VAR)
        INTEGER(INT_KIND_1BYTE), INTENT(IN) :: INT_VAR
        CALL REGISTER_FAILED
        WRITE(INFO, '(A, I0, A)') "ASSERT_IS_COMPLEX: ", INT_VAR, " (INT)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    END SUBROUTINE ASSERT_IS_COMPLEX_INT_1BYTE

    SUBROUTINE ASSERT_IS_COMPLEX_INT_2BYTE(INT_VAR)
        INTEGER(INT_KIND_2BYTE), INTENT(IN) :: INT_VAR
        CALL REGISTER_FAILED
        WRITE(INFO, '(A, I0, A)') "ASSERT_IS_COMPLEX: ", INT_VAR, " (INT)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    END SUBROUTINE ASSERT_IS_COMPLEX_INT_2BYTE

    SUBROUTINE ASSERT_IS_COMPLEX_INT_4BYTE(INT_VAR)
        INTEGER(INT_KIND_4BYTE), INTENT(IN) :: INT_VAR
        CALL REGISTER_FAILED
        WRITE(INFO, '(A, I0, A)') "ASSERT_IS_COMPLEX: ", INT_VAR, " (INT)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    END SUBROUTINE ASSERT_IS_COMPLEX_INT_4BYTE

    SUBROUTINE ASSERT_IS_COMPLEX_INT_8BYTE(INT_VAR)
        INTEGER(INT_KIND_8BYTE), INTENT(IN) :: INT_VAR
        CALL REGISTER_FAILED
        WRITE(INFO, '(A, I0, A)') "ASSERT_IS_COMPLEX: ", INT_VAR, " (INT)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    END SUBROUTINE ASSERT_IS_COMPLEX_INT_8BYTE

    SUBROUTINE ASSERT_IS_COMPLEX_CHAR(CHAR_VAR)
        CHARACTER(*), INTENT(IN) :: CHAR_VAR
        CALL REGISTER_FAILED
        WRITE(INFO, '(A, A, A)') "ASSERT_IS_COMPLEX: ", CHAR_VAR, " (CHAR)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    END SUBROUTINE ASSERT_IS_COMPLEX_CHAR

    SUBROUTINE ASSERT_IS_COMPLEX_BOOL(BOOL_VAR)
        LOGICAL, INTENT(IN) :: BOOL_VAR
        CALL REGISTER_FAILED
        WRITE(INFO, '(A, L1, A)') "ASSERT_IS_COMPLEX: ", BOOL_VAR, " (LOGICAL)"
        INFO_STRINGS = APPEND_CHAR(INFO_STRINGS, INFO, LEN(INFO))
    END SUBROUTINE ASSERT_IS_COMPLEX_BOOL

    SUBROUTINE ASSERT_IS_COMPLEX_COMPLEX(COMP_VAR)
        COMPLEX, INTENT(IN) :: COMP_VAR
        CALL REGISTER_PASSED
        WRITE(INFO, '(A, F0.5, A, F0.5, A, A)') "ASSERT_NOT_EQUAL: ", REAL(COMP_VAR), " &
               & + ", AIMAG(COMP_VAR), "I", " (COMPLEX)"
    ...
    SUBROUTINE VAL_IN_ARR_INT_1BYTE(ARRAY, VAL)
        INTEGER(INT_KIND_1BYTE), INTENT(IN) :: VAL
        INTEGER(INT_KIND_1BYTE), DIMENSION(:), INTENT(IN) :: ARRAY
    ...
    SUBROUTINE VAL_IN_ARR_INT_2BYTE(ARRAY, VAL)
        INTEGER(INT_KIND_2BYTE), INTENT(IN) :: VAL
        INTEGER(INT_KIND_2BYTE), DIMENSION(:), INTENT(IN) :: ARRAY
    ...
    SUBROUTINE VAL_IN_ARR_INT_4BYTE(ARRAY, VAL)
        INTEGER(INT_KIND_4BYTE), INTENT(IN) :: VAL
        INTEGER(INT_KIND_4BYTE), DIMENSION(:), INTENT(IN) :: ARRAY
    ...
    SUBROUTINE VAL_IN_ARR_INT_8BYTE(ARRAY, VAL)
        INTEGER(INT_KIND_8BYTE), INTENT(IN) :: VAL
        INTEGER(INT_KIND_8BYTE), DIMENSION(:), INTENT(IN) :: ARRAY
