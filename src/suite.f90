MODULE FUTF_SUITE
    ...
    PUBLIC :: FUTF_PASSED, FUTF_TOTAL, FUTF_EXIT_CODE
    PUBLIC :: IDENTIFIER, TEST_NAMES, TEST_RESULTS, INFO_STRINGS
    PUBLIC :: TAG_TEST, REGISTER_PASSED, REGISTER_FAILED
    PUBLIC :: TEST_SUMMARY, FAILED_TEST_SUMMARY
    PUBLIC :: RESET_LAST_TEST_STATUS
